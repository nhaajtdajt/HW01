...
> Reference version, drafted with Claude (Claude Code, Opus 5) and checked line by line against the official **ISTQB CTFL v4.0 syllabus PDF, dated 2023-04-21**, for use as the *corrected* mindmap required by G9.1.
> Declare it in `[AI-02]` like any other AI-assisted artifact. **If your class uses syllabus v3.1 rather than v4.0, sections 4, 5 and 6 below differ** — v3.1 has four test levels and lists change-related testing as a test type.
