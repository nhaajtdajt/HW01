...
Each entry ends with **"AI hallucination / bias found"**, filled in after asking an AI tool to explain the defect (procedure in `R2_ai_prompts.md`).
...
**AI hallucination / bias found:** ✍️ *(student — after Prompt R2-01)*
...
**AI hallucination / bias found:** ✍️ *(student — after Prompt R2-02)*
...
**AI hallucination / bias found:** ✍️ *(student — after Prompt R2-03)*
...
**AI hallucination / bias found:** ✍️ *(student — after Prompt R2-04)*
...
**AI hallucination / bias found:** ✍️ *(student — after Prompt R2-05)*
...
**AI hallucination / bias found:** ✍️ *(student — after Prompt R2-06)*
...
**AI hallucination / bias found:** ✍️ *(student — after Prompt R2-07)*
...
**AI hallucination / bias found:** ✍️ *(student — after Prompt R2-08)*
...
**AI hallucination / bias found:** ✍️ *(student — after Prompt R2-09)*
...
**AI hallucination / bias found:** ✍️ *(student — after Prompt R2-10)*
...
**AI hallucination / bias found:** ✍️ *(student — after Prompt R2-11)*
...
**AI hallucination / bias found:** ✍️ *(student — after Prompt R2-12)*
...
**AI hallucination / bias found:** ✍️ *(student — after Prompt R2-13)*
...
**AI hallucination / bias found:** ✍️ *(student — after Prompt R2-14)*
...
**AI hallucination / bias found:** ✍️ *(student — after Prompt R2-15)*
...
**AI hallucination / bias found:** ✍️ *(student — after Prompt R2-16)*
...
**AI hallucination / bias found:** ✍️ *(student — after Prompt R2-17)*
...
**AI hallucination / bias found:** ✍️ *(student — after Prompt R2-18)*
...
**AI hallucination / bias found:** ✍️ *(student — after Prompt R2-19)*
...
**AI hallucination / bias found:** ✍️ *(student — after Prompt R2-20)*
