...
|---|---|---|---|---|---|---|---|
| **TC01** | Gemini | Xác minh phím 1/2/3 kích hoạt đúng cấp gió tương ứng và phím 0 ngắt động cơ hoàn toàn. | Mỗi lần nhấn: phím mới chìm xuống, phím cũ nảy lên hết. Tốc độ tăng dần qua 3 cấp. Nhấn 0 thì động cơ ngắt, cánh giảm tốc theo quán tính rồi dừng. Không rè, không rung bất thường. | Mỗi lần bấm, phím trước nảy lên và phím mới chìm xuống. Động cơ chạy ở cả 3 cấp, gió tăng dần. Bấm 0 thì phím 3 nảy lên, cánh giảm tốc theo quán tính rồi dừng hẳn, không rè, không rung bất thường. | **Pass** |  | [link](https://youtube.com/shorts/JEd-FkanM2o) |
| **TC02** | Gemini | Xác minh cơ chế quay quét tự động và khả năng cố định hướng thổi bằng chốt tuốc năng. | Ấn chốt: đầu quạt quét mượt trái-phải, biên độ khoảng 80-90 độ, không va đập, không kẹt bánh răng. Kéo chốt: dừng quét ngay tại vị trí hiện tại, cánh vẫn quay bình thường. | Khi ấn chốt, đầu quạt quét đều hai bên, không kêu lục cục, không khựng. Khi kéo chốt lên, quạt dừng quét ngay tại vị trí đang đứng và giữ nguyên hướng thổi, cánh vẫn quay bình thường. | **Pass** |  | [link](https://youtube.com/shorts/eEpm26qTveE) |
| **TC03** | Gemini (rút gọn) | Đảm bảo khớp gập cổ quạt giữ được góc ngẩng/cúi dưới áp lực gió ở tốc độ cao nhất. | Khớp giữ nguyên góc trong 30 giây ở cả hai vị trí, không tự trôi hoặc gục xuống dưới phản lực gió. | Sau khi buông tay, khớp gập giữ nguyên góc ở cả hai vị trí (ngửa hết cỡ và cúi hết cỡ) trong suốt 30 giây quan sát. Không tự trôi, không gục xuống dưới phản lực gió ở số 3. | **Pass** |  |  |
| **TC05** | Claude (thay case có rủi ro làm hỏng thêm) | Kiểm tra nhãn thông số và cảnh báo an toàn còn nguyên vẹn và đọc được, theo yêu cầu ghi nhãn của TCVN 5699-1 (IEC 60335-1). | Toàn bộ thông tin bắt buộc còn đọc được rõ ràng. Tem bám chắc, không bong góc, chữ không nhòe sau khi chà nhẹ. | Toàn bộ thông tin bắt buộc trên tem còn đọc rõ: hãng SENKO, 220V/50Hz/40W, cấp cách điện E, cấp chống giật điện cấp 0, TCVN 5699-2-80:2007 (IEC 60335-2-80:2005), lô SX 107, tháng SX 07-2022. Chà nhẹ mặt tem 5 lần, chữ không nhòe. Tem bám chắc, không bong góc, không bị che khuất. | **Pass** |  |  |
| **TC06** | Claude (thay test kẹt cánh không an toàn) | Phát hiện tiếng cơ khí bất thường và xác nhận độ ồn tăng hợp lý theo từng cấp gió. | Độ ồn tăng dần theo cấp. Chỉ có tiếng gió và tiếng động cơ đều, không có tiếng lạch cạch theo nhịp, không rít, không va đập. | Đánh giá bằng tai, không dùng thiết bị đo. Độ ồn tăng dần qua ba cấp, cấp 3 ồn nhất. Chỉ nghe thấy tiếng gió và tiếng động cơ đều; không có tiếng lạch cạch theo nhịp, không tiếng rít kim loại, không tiếng va đập từ hộp tuốc năng. | **Pass** |  | Quan sát trực tiếp (không quay video) |
| **TC07** | Gemini | Xác minh động cơ khởi động lại an toàn khi mất điện rồi có điện lại trong lúc công tắc vẫn ở vị trí bật. | Không có tia lửa lớn tại chân phích. Động cơ khởi động lại êm, cánh đạt lại tốc độ bình thường, không kẹt rotor, không ù kéo dài. | Không quan sát thấy tia lửa tại chân phích khi cắm lại. Động cơ khởi động lại ngay, cánh đạt lại tốc độ bình thường, không kẹt rotor, không có tiếng ù kéo dài. | **Pass** |  |  |
| **TC09** | Sinh viên | Xác minh ba cấp gió thực sự khác nhau về lưu lượng, không phải chỉ khác trên nhãn phím. | Góc bay của dải giấy tăng rõ rệt qua từng cấp. Không có hai cấp nào cho góc bay gần như bằng nhau. | Độ bay của tờ giấy tăng rõ rệt qua từng cấp: cấp 1 giấy lay nhẹ, cấp 2 bay mạnh hơn, cấp 3 bay mạnh nhất. Ba cấp phân biệt được bằng mắt thường, không có hai cấp nào cho kết quả giống nhau. | **Pass** |  | [link](https://youtube.com/shorts/WYQW7PdwYas) |
| **TC10** | Sinh viên — EDGE CASE AI BỎ SÓT | Kiểm tra cụm công tắc khi chuyển cấp với khoảng cách thời gian rất ngắn, mô phỏng thao tác tay thật của người dùng. | Quạt chuyển sang cấp 2 và tiếp tục chạy. Không được rơi về trạng thái tắt, không được kẹt giữa hai phím. | Quạt không nhận cấp tốc độ nào. Cả hai phím đều nảy lên vị trí ngắt, động cơ mất điện và dừng hẳn. Phải bấm lại một lần nữa quạt mới chạy. Tái hiện 3/3 lần. Ngưỡng quan sát: bấm cách nhau từ 0,5 giây trở lên thì chuyển cấp bình thường, nhanh hơn thì quạt tắt. | **Fail** | DEF-01 | [link](https://youtube.com/shorts/HPpBDBBYLWI) |
| **TC11** | Sinh viên | Xác minh động cơ tự khởi động được ở cấp thấp nhất khi nguội, tức tụ đề còn đủ mô-men khởi động. | Cánh tự quay trong vòng 2 giây, không cần quay mồi, không phát tiếng ù kéo dài. | Cánh tự quay sau khoảng 1 giây, không có tiếng ù. | **Pass** |  |  |
| **TC12** | Sinh viên — EDGE CASE AI BỎ SÓT | Xác minh cơ cấu đảo gió hoạt động và giữ nguyên biên độ quét ở cả ba cấp tốc độ. | Quạt quét được ở cả ba cấp. Biên độ quét ở ba cấp bằng nhau, sai lệch không đáng kể. | Quét được ở cả ba cấp, biên độ ba lần đo như nhau. | **Pass** |  |  |
| **TC13** | Sinh viên — EDGE CASE AI BỎ SÓT | Kiểm tra khe hở nan lồng bảo vệ theo yêu cầu an toàn của TCVN 5699-2-80 (tương đương IEC 60335-2-80): vật thăm dò không được chạm tới cánh. | Không vị trí nào đưa ngón tay chạm được vào cánh quạt. | Không chạm được cánh ở mọi vị trí thử. | **Pass** |  |  |
| **TC14** | Sinh viên | Kiểm tra yêu cầu an toàn: lồng bảo vệ chỉ được tháo ra khi dùng dụng cụ, theo TCVN 5699-2-80. | Không tháo được lồng bảo vệ nếu không dùng dụng cụ. | Lồng bảo vệ tháo được bằng tay không khá dễ dàng, các chốt nhựa có thể bật ra bằng ngón tay. | **Inconclusive** |  | Quan sát trực tiếp (không quay video) |
| **TC15** | Sinh viên | Kiểm tra cơ cấu tuốc năng có tự phục hồi đúng biên độ sau khi bị bẻ vượt quá hành trình quét. | Quạt quét lại đúng biên độ ban đầu, hai điểm cuối trùng với vạch đánh dấu. | Cánh vẫn quay bình thường nhưng hành trình quét bị dịch hẳn sang một bên; hai điểm cuối không còn trùng mốc ban đầu. Quạt không tự phục hồi dù chạy tiếp, phải tắt và chỉnh lại bằng tay. Tái hiện 2/2 lần. | **Fail** | DEF-02 | [link](https://youtube.com/shorts/Dtg48KkCVdo) |
| **TC16** | Claude (bổ sung) | Kiểm tra tính toàn vẹn của dây nguồn, phích cắm và cơ cấu giữ dây — đặc biệt quan trọng vì quạt thuộc cấp chống giật điện cấp 0, không có tiếp địa bảo vệ. | Vỏ cách điện liền lạc, không nứt, không chai, không cháy. Chân phích thẳng và chắc. Dây không xê dịch tại điểm vào thân, không lộ lõi đồng. | Vỏ cách điện liền lạc trên toàn bộ chiều dài dây, không nứt, không chai cứng, không cháy xém. Chân phích thẳng và chắc, không gỉ. Kéo nhẹ dây tại điểm vào thân quạt, dây không xê dịch, không lộ lõi đồng. | **Pass** |  | Quan sát trực tiếp (không quay video) |
| **TC17** | Claude (bổ sung, rút gọn 10 phút -> 3 phút) | Kiểm tra độ cân bằng cánh và độ ổn định của đế: quạt không được tự dịch chuyển do rung khi chạy ở tốc độ cao nhất kèm đảo gió. | Đồng xu không trượt khỏi đế. Chân đế không lệch khỏi vạch đánh dấu. Thân quạt không rung lắc thấy rõ bằng mắt. | Sau 3 phút chạy số 3 kèm đảo gió, đồng xu vẫn nằm nguyên trên đế, không trượt, không rơi. Chân đế không lệch khỏi vạch băng keo đánh dấu. Không quan sát thấy rung lắc thân quạt bằng mắt thường. | **Pass** |  | Quan sát trực tiếp (không quay video) |
...
> Phần mô tả lỗi, các bước tái hiện, kết quả thực tế, nguyên nhân dự đoán và ảnh hưởng người dùng trong ba issue dưới đây **do sinh viên tự viết 100% sau khi trực tiếp thực thi test case**. Đã khai trong `[AI-03]` mục 4.
